document.querySelector(".busca").addEventListener("submit", async (e) => {
  ...
  if (input !== "") {
    clearInfo();
    showWarning("Loading, please wait...");
    let KEY = "53439d38f11a76b4eafc8ee4a4f1174a";
   ...
   `;
    ...
    if (json.cod === 200) {
      ...
      clearInfo();
      showWarning("Error:" + json.message);
    }
  }
  if (input === "") {
    clearInfo();
    showWarning("Empty, please write a city name!");
  }
});
...
function showInfo(json) {
  ...
  document.querySelector(".degrees").innerHTML = `${json.windAngle}°`;
  document.querySelector(
    ".ventoInfo"
